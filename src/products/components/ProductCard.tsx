...
export const ProductCard = ({ product, fullDescription, prefetchProduct }: Props) => {
	return (
		...
		>
			<Card className='relative flex flex-col md:flex-row md:space-x-5 space-y-3 md:space-y-0 p-3 max-w-xs md:max-w-3xl mx-auto border border-white bg-white h-full'>
